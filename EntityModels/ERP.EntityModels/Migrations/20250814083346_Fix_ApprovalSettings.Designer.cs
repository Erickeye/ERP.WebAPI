...
namespace ERP.EntityModels.Migrations
{
    ...
    [Migration("20250814083346_Fix_ApprovalSettings")]
    partial class Fix_ApprovalSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.EntityModels.Models.Other.ApprovalStepNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.EntityModels.Models._1000Company.t_1030Dayoff", b =>
                {
                    ...
                    b.Property<int>("LeaveTaker")
                        .HasColumnType("int");

                    b.Property<int>("LeaveType")
                        .HasColumnType("int");

                    b.Property<int?>("Proxy")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Models.AMS.Permission", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Models.AMS.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProcurementLevel")
                        .HasColumnType("int");

                    b.Property<int?>("QuotationLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Models.AMS.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.EntityModels.Models._1000Company.t_1030Dayoff", b =>
                {
                    b.HasOne("ERP.EntityModels.Models._1000Company.t_1000Staff", "Staff_Applicant")
                        .WithMany()
                        .HasForeignKey("Applicant");

                    b.HasOne("ERP.EntityModels.Models._1000Company.t_1000Staff", "Staff_LeaveTaker")
                        .WithMany()
                        .HasForeignKey("LeaveTaker")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.EntityModels.Models._1000Company.t_1000Staff", "Staff_Proxy")
                        .WithMany()
                        .HasForeignKey("Proxy");

                    b.Navigation("Staff_Applicant");

                    b.Navigation("Staff_LeaveTaker");

                    b.Navigation("Staff_Proxy");
                });
            ...
            modelBuilder.Entity("ERP.Models.AMS.Permission", b =>
                {
                    b.HasOne("ERP.Models.AMS.Role", "Role")
                        .WithMany()
